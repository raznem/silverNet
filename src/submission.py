...
PRETRAINED = '../models/'
DETECTION_TEST_PRED = '../data/fine-tuning-resnet34-on-ship-detection-new-data/ship_detection.csv'
...
def split_mask(mask):
    threshold = 0.5
    threshold_obj = 30 # ignore predictions composed of "threshold_obj" pixels or less
...
learn.models_path = PRETRAINED
learn.load('Unet34_768_1p3')
